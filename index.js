...
function findStringLength(str) {
  ...
  let findStringLength = str.length;
...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  ...
  const generateStringFromCharCode = String.fromCharCode(code1, code2, code3, code4, code5);
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  ...
  const generateStringFromCodePoint = String.fromCodePoint(code1, code2, code3, code4);
...
function rawString() {
  ...
  let rawString = String.raw `Привіт\u000A!`;
  return rawString;
}
...
function concatenateStrings(str1, str2) {
  ...
  let concatenateStrings = str1.concat(str2);
